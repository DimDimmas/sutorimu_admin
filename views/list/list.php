...
<div class="main">
        ...
        <br>
        <a class="add-new" data-toggle="modal" href="?page=add_list">
          ...
          <table class="table table-striped table-dark">
            ...
            ?>
              <tr>
                ...
                <td><center><a href="?page=edit_list" data-id="<?php echo $data->id_list; ?>"><i class="fas fa-pen edit"></i></a></center></td>
